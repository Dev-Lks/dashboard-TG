        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 md:py-0">
          <div className="flex min-h-12 items-center justify-between gap-3 md:min-h-14">
            ...
            <div className="min-w-0">
              <div className="truncate font-extrabold tracking-tight text-[var(--olive-900)]">Comando Administrativo</div>
              <div className="hidden text-[10px] font-mono uppercase tracking-[0.18em] text-[var(--text-muted)] md:block">TG 11 • Posto de comando</div>
            </div>
            </Link>
            ...
            <form action={async () => { 'use server'; await logoutAdmin(); }}>
              <button type="submit" className="btn-auto flex h-10 w-10 items-center justify-center rounded border border-[var(--border)] text-[var(--text-muted)] hover:bg-[var(--surface-muted)] hover:text-[var(--text)] sm:w-auto sm:px-3">
